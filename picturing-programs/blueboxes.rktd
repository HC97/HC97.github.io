2451
((3) 0 () 4 ((q lib "picturing-programs/private/map-image.rkt") (q lib "picturing-programs/private/tiles.rkt") (q lib "picturing-programs/private/io-stuff.rkt") (q lib "picturing-programs/private/book-pictures.rkt")) () (h ! (equal) ((c def c (c (? . 0) q fold-image/extra)) q (5400 . 11)) ((c def c (c (? . 1) q rotate-cw)) q (56 . 3)) ((c def c (c (? . 0) q map-image)) q (3268 . 7)) ((c def c (c (? . 1) q reflect-vert)) q (743 . 3)) ((c def c (c (? . 0) q name->color)) q (1212 . 3)) ((c def c (c (? . 1) q rotate-ccw)) q (114 . 3)) ((c def c (c (? . 1) q crop-top)) q (232 . 4)) ((c def c (c (? . 2) q with-output-to-string)) q (5919 . 3)) ((c def c (c (? . 2) q with-io-strings)) q (6323 . 4)) ((c def c (c (? . 0) q colorize)) q (1309 . 3)) ((q def ((lib "picturing-programs/main.rkt") show-it)) q (0 . 3)) ((c def c (c (? . 0) q color=?)) q (1422 . 4)) ((c def c (c (? . 3) q pic:book)) q (1089 . 2)) ((c def c (c (? . 0) q map3-image)) q (4568 . 9)) ((c def c (c (? . 1) q reflect-main-diag)) q (866 . 3)) ((c def c (c (? . 1) q crop-bottom)) q (329 . 4)) ((c def c (c (? . 0) q fold-image)) q (5128 . 9)) ((c def c (c (? . 2) q with-input-from-url)) q (6222 . 4)) ((c def c (c (? . 3) q pic:hacker)) q (1061 . 2)) ((c def c (c (? . 1) q crop-right)) q (527 . 4)) ((c def c (c (? . 2) q with-input-from-file)) q (5999 . 4)) ((c def c (c (? . 0) q build-image)) q (1694 . 5)) ((c def c (c (? . 1) q reflect-horiz)) q (804 . 3)) ((c def c (c (? . 0) q map4-image)) q (3770 . 11)) ((c def c (c (? . 0) q build4-image)) q (2086 . 14)) ((c def c (c (? . 0) q build3-image)) q (2750 . 11)) ((c def c (c (? . 0) q get-pixel-color)) q (1570 . 5)) ((c def c (c (? . 3) q pic:hieroglyphics)) q (1026 . 2)) ((c def c (c (? . 0) q build-image/extra)) q (1870 . 6)) ((c def c (c (? . 0) q real->int)) q (5752 . 3)) ((c def c (c (? . 2) q with-input-from-string)) q (5811 . 4)) ((c def c (c (? . 0) q map-image/extra)) q (3480 . 9)) ((c def c (c (? . 1) q reflect-other-diag)) q (932 . 3)) ((c def c (c (? . 3) q pic:scheme-logo)) q (1149 . 2)) ((c def c (c (? . 1) q crop-left)) q (429 . 4)) ((c def c (c (? . 3) q pic:stick-figure)) q (1115 . 2)) ((c def c (c (? . 1) q rotate-180)) q (173 . 3)) ((c def c (c (? . 3) q pic:calendar)) q (1182 . 2)) ((c def c (c (? . 1) q flip-other)) q (684 . 3)) ((c def c (c (? . 1) q flip-main)) q (626 . 3)) ((c def c (c (? . 2) q with-output-to-file)) q (6111 . 4)) ((c def c (c (? . 3) q pic:bloch)) q (999 . 2))))
procedure
(show-it img) -> image?
  img : image?
procedure

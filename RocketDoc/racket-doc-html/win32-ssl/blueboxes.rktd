353
((3) 0 () 1 ((q lib "net/win32-ssl.rkt")) () (h ! (equal) ((c def c (c (? . 0) q win32-ssl-port?)) q (1072 . 3)) ((c def c (c (? . 0) q win32-ssl-connect)) q (0 . 11)) ((c def c (c (? . 0) q win32-ssl-available?)) q (1133 . 2)) ((c def c (c (? . 0) q ports->win32-ssl-ports)) q (546 . 12)) ((c def c (c (? . 0) q win32-ssl-abandon-port)) q (446 . 3))))
procedure

41551
((3) 0 () 30 ((q lib "drracket/tool-lib.rkt") (c (? . 0) q drracket:unit:frame<%>) (c (? . 0) q drracket:rep:text%) (c (? . 0) q drracket:language:module-based-language<%>) (c (? . 0) q drracket:language:simple-module-based-language->module-based-language-mixin) (c (? . 0) q drracket:unit:frame%) (c (? . 0) q drracket:unit:tab<%>) (c (? . 0) q drracket:frame:basics-mixin) (c (? . 0) q drracket:language:language<%>) (c (? . 0) q drracket:frame:<%>) (q 40780 . 9) (q 38759 . 22) (c (? . 0) q drracket:language:simple-module-based-language<%>) (c (? . 0) q drracket:module-language-tools:definitions-text<%>) (q 63730 . 11) (c (? . 0) q drracket:unit:definitions-text<%>) (q 38411 . 6) (c (? . 0) q drracket:rep:context<%>) (c (? . 0) q drracket:language:module-based-language->language-mixin) (c (? . 0) q drracket:unit:tab%) (q 17754 . 11) (c (? . 0) q drracket:debug:profile-unit-frame-mixin) (c (? . 0) q drracket:language:simple-module-based-language%) (c (? . 0) q drracket:unit:program-editor-mixin) (c (? . 0) q drracket:unit:interactions-canvas%) (q lib "drracket/syncheck-drracket-button.rkt") (c (? . 0) q drracket:frame:name-message%) (c (? . 0) q drracket:rep:drs-bindings-keymap-mixin) (c (? . 0) q drracket:module-language:module-language<%>) (q lib "lang/htdp-langs-save-file-prefix.rkt")) () (h ! (equal) ((c meth c (c (? . 1) q get-insert-menu)) q (13330 . 2)) ((c def c (c (? . 0) q drracket:language:make-setup-printing-parameters)) q (38259 . 3)) ((c meth c (c (? . 13) q get-in-module-language?)) q (67385 . 3)) ((c meth c (c (? . 1) q open-in-new-tab)) q (11860 . 9)) ((c meth c (c (? . 4) q unmarshall-settings)) q (22576 . 3)) ((c meth c (c (? . 1) q get-current-tab)) q (11578 . 3)) ((c meth c (c (? . 1) q register-toolbar-button)) q (14229 . 7)) ((c def c (c (? . 0) q drracket:modes:mode)) c (? . 14)) ((c def c (c (? . 0) q drscheme:frame:<%>)) q (70854 . 2)) ((c meth c (c (? . 6) q is-running?)) q (6263 . 2)) ((c meth c (c (? . 3) q unmarshall-settings)) q (25462 . 4)) ((c def c (c (? . 0) q drscheme:get/extend:get-interactions-text)) q (79572 . 3)) ((c meth c (c (? . 2) q on-highlighted-errors)) q (52496 . 3)) ((c def c (c (? . 0) q drscheme:unit:add-to-program-editor-mixin)) q (90871 . 3)) ((c def c (c (? . 0) q drracket:module-language-tools:tab-mixin)) q (68138 . 4)) ((c def c (c (? . 0) q drscheme:unit:get-program-editor-mixin)) q (90762 . 3)) ((c def c (c (? . 0) q drracket:get/extend:disallow-re-extension!)) q (5209 . 2)) ((c def c (c (? . 0) q drracket:debug:test-coverage-enabled)) q (45643 . 4)) ((c def c (c (? . 0) q drscheme:module-language-tools:add-online-expansion-handler)) q (88886 . 6)) ((c def c (c (? . 0) q drracket:language-configuration:make-language-settings)) q (41207 . 3)) ((c def c (c (? . 0) q drscheme:unit:definitions-canvas%)) q (69718 . 2)) ((c def c (c (? . 0) q drscheme:language:capability-registered?)) q (82799 . 2)) ((c meth c (c (? . 2) q queue-output)) q (52867 . 3)) ((c def c (c (? . 0) q drscheme:rep:drs-bindings-keymap-mixin)) q (69871 . 2)) ((c def c (? . 15)) q (15114 . 2)) ((c meth c (c (? . 2) q after-insert)) q (50897 . 2)) ((c def c (c (? . 0) q drscheme:modes:mode-matches-language)) q (87938 . 3)) ((c def c (c (? . 0) q drscheme:language:get-language-extensions)) q (83651 . 3)) ((c def c (? . 24)) q (7940 . 3)) ((c def c (? . 7)) q (56388 . 4)) ((c def c (? . 3)) q (22832 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:get-interactions-canvas)) q (80324 . 3)) ((c meth c (c (? . 2) q insert-prompt)) q (52687 . 2)) ((c def c (c (? . 0) q drracket:language:simple-settings?)) c (? . 11)) ((c meth c (c (? . 5) q update-save-button)) q (10904 . 4)) ((c meth c (c (? . 4) q default-settings?)) q (21704 . 3)) ((c def c (c (? . 0) q drracket:debug:bug-info->ticket-url)) q (46056 . 3)) ((c meth c (c (? . 12) q get-one-line-summary)) q (18925 . 3)) ((c def c (c (? . 0) q drracket:language-configuration:add-language)) q (40170 . 8)) ((c def c (c (? . 0) q drracket:get/extend:extend-definitions-canvas)) q (3912 . 9)) ((c meth c (c (? . 8) q order-manuals)) q (30339 . 4)) ((c meth c (c (? . 3) q get-transformer-module)) q (23965 . 3)) ((c meth c (c (? . 3) q use-namespace-require/copy?)) q (25688 . 3)) ((c def c (c (? . 0) q drscheme:language:language<%>)) q (70079 . 2)) ((c meth c (c (? . 2) q shutdown)) q (53183 . 2)) ((c meth c (c (? . 23) q after-delete)) q (7580 . 6)) ((c meth c (c (? . 5) q file-menu:between-open-and-revert)) q (9131 . 4)) ((c meth c (c (? . 5) q update-shown)) q (11104 . 2)) ((c meth c (c (? . 3) q render-value)) q (24556 . 9)) ((c def c (c (? . 0) q drracket:language:get-default-mixin)) q (32733 . 3)) ((c meth c (c (? . 6) q enable-evaluation)) q (5614 . 2)) ((c meth c (c (? . 3) q config-panel)) q (22900 . 4)) ((c def c (c (? . 0) q drracket:debug:show-backtrace-window/edition-pairs)) q (46920 . 21)) ((c meth c (c (? . 1) q get-definitions-text)) q (13222 . 3)) ((c meth c (c (? . 3) q default-settings?)) q (23156 . 4)) ((c def c (? . 17)) q (53608 . 2)) ((c meth c (c (? . 5) q get-editor)) q (10263 . 2)) ((c def c (c (? . 0) q drracket:unit:add-search-help-desk-menu-item)) q (17315 . 9)) ((c meth c (c (? . 7) q file-menu:open-callback)) q (57248 . 6)) ((c def c (c (? . 0) q drracket:language:make-text/pos)) q (38649 . 2)) ((c meth c (c (? . 7) q help-menu:create-about?)) q (58070 . 3)) ((c def c (c (? . 0) q struct:drracket:language-configuration:language-settings)) c (? . 10)) ((c meth c (c (? . 6) q get-ints)) q (6116 . 3)) ((c def c (c (? . 0) q drscheme:debug:small-planet-bitmap)) q (72458 . 2)) ((c def c (c (? . 0) q drscheme:debug:error-display-handler/stacktrace)) q (71232 . 8)) ((c def c (c (? . 0) q drscheme:language:create-executable-gui)) q (83943 . 12)) ((c constructor c (? . 5)) q (8319 . 3)) ((c def c (c (? . 0) q drracket:eval:traverse-program/multiple)) q (60576 . 16)) ((c def c (c (? . 0) q make-drracket:unit:teachpack-callbacks)) c (? . 20)) ((c def c (c (? . 0) q drscheme:eval:set-basic-parameters)) q (75270 . 5)) ((c def c (c (? . 0) q drscheme:get/extend:disallow-re-extension!)) q (80435 . 2)) ((c meth c (c (? . 8) q get-reader-module)) q (29122 . 3)) ((c meth c (c (? . 2) q get-error-range)) q (51607 . 3)) ((c def c (c (? . 0) q drscheme:rep:get-drs-bindings-keymap)) q (90261 . 2)) ((c constructor c (? . 22)) q (19335 . 18)) ((c meth c (c (? . 9) q set-show-menu-sort-key)) q (58502 . 5)) ((c def c (c (? . 0) q drracket:get/extend:get-interactions-canvas)) q (5097 . 3)) ((c meth c (c (? . 28) q get-users-language-name)) q (67114 . 3)) ((c meth c (c (? . 9) q update-shown)) q (58783 . 2)) ((c meth c (c (? . 1) q get-definitions-canvas)) q (13110 . 3)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-on-style-name)) q (72150 . 2)) ((c def c (c (? . 0) q drscheme:unit:make-teachpack-callbacks)) q (91941 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:extend-interactions-text)) q (79316 . 6)) ((c def c (c (? . 0) q drracket:language-configuration:language-settings-language)) c (? . 10)) ((c def c (c (? . 0) q drracket:debug:make-debug-error-display-handler)) q (45096 . 4)) ((c def c (c (? . 0) q drracket:language:simple-settings-fraction-style)) c (? . 11)) ((c def c (c (? . 0) q drscheme:rep:get-welcome-delta)) q (90047 . 2)) ((c def c (c (? . 0) q drscheme:module-language-tools:done?)) q (89685 . 2)) ((c meth c (c (? . 12) q get-module)) q (18830 . 3)) ((c meth c (c (? . 5) q change-to-tab)) q (8821 . 3)) ((c meth c (c (? . 2) q wait-for-io-to-complete)) q (53239 . 2)) ((c def c (c (? . 0) q drracket:language:simple-settings-insert-newlines)) c (? . 11)) ((c meth c (c (? . 1) q sort-toolbar-buttons-panel)) q (15037 . 3)) ((c meth c (c (? . 5) q file-menu:between-print-and-close)) q (9261 . 4)) ((c def c (c (? . 0) q drracket:debug:test-coverage-frame-mixin)) q (44151 . 4)) ((c def c (? . 13)) q (67210 . 2)) ((c def c (c (? . 0) q drscheme:unit:definitions-text<%>)) q (70928 . 2)) ((c def c (c (? . 0) q drracket:rep:get-drs-bindings-keymap)) q (54853 . 2)) ((c meth c (c (? . 1) q close-current-tab)) q (12844 . 2)) ((c def c (c (? . 0) q drscheme:language:register-capability)) q (82590 . 7)) ((c def c (c (? . 0) q drracket:language:register-capability)) q (31371 . 7)) ((c def c (c (? . 0) q drracket:module-language:module-language-put-file-mixin)) q (68395 . 4)) ((c def c (c (? . 0) q drracket:language-configuration:language-settings-settings)) c (? . 10)) ((c def c (c (? . 0) q drscheme:debug:show-backtrace-window/edition-pairs)) q (73071 . 16)) ((c form c (c (? . 0) q drracket:tool^)) q (472 . 2)) ((c def c (c (? . 0) q drracket:rep:get-error-delta)) q (54783 . 2)) ((c def c (c (? . 0) q drracket:language:struct:simple-settings)) q (39847 . 2)) ((c def c (c (? . 0) q drracket:rep:after-expression)) q (55088 . 4)) ((c meth c (c (? . 5) q make-searchable)) q (10586 . 3)) ((c def c (c (? . 0) q drscheme:language:extend-language-interface)) q (83392 . 5)) ((c def c (c (? . 0) q drracket:debug:get-error-color-name)) q (49945 . 3)) ((c def c (c (? . 0) q drracket:module-language-tools:definitions-text-mixin)) q (67618 . 7)) ((c meth c (c (? . 8) q marshall-settings)) q (29810 . 4)) ((c meth c (c (? . 1) q close-given-tab)) q (12996 . 3)) ((c meth c (c (? . 4) q marshall-settings)) q (22111 . 3)) ((c def c (c (? . 0) q drracket:get/extend:allow-re-extension!)) q (5275 . 2)) ((c meth c (c (? . 1) q register-toolbar-buttons)) q (14543 . 7)) ((c def c (c (? . 0) q drracket:modes:mode-matches-language)) c (? . 14)) ((c meth c (c (? . 6) q can-close?)) q (5487 . 2)) ((c def c (c (? . 0) q struct:drracket:language:text/pos)) c (? . 16)) ((c meth c (c (? . 1) q get-interactions-canvas)) q (13406 . 3)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-enabled)) q (72079 . 2)) ((c def c (c (? . 0) q drracket:debug:get-error-color)) q (49879 . 2)) ((c def c (c (? . 0) q drracket:modes:get-modes)) q (64298 . 2)) ((c def c (? . 12)) q (18496 . 2)) ((c def c (c (? . 0) q drracket:language-configuration:language-settings?)) c (? . 10)) ((c meth c (c (? . 3) q get-module)) q (23647 . 3)) ((c def c (c (? . 0) q struct:drracket:language:simple-settings)) c (? . 11)) ((c meth c (c (? . 18) q get-language-name)) q (26292 . 3)) ((c def c (c (? . 0) q drracket:eval:expand-program/multiple)) q (61362 . 18)) ((c def c (c (? . 0) q drscheme:debug:get-error-color-name)) q (74892 . 3)) ((c def c (c (? . 0) q drscheme:language-configuration:language-dialog)) q (81878 . 5)) ((c def c (c (? . 0) q drracket:language:simple-settings-annotations)) c (? . 11)) ((c meth c (c (? . 4) q default-settings)) q (21584 . 3)) ((c meth c (c (? . 2) q wait-for-io-to-complete/user)) q (53310 . 3)) ((c form c (c (? . 0) q drracket:tool-exports^)) q (511 . 2)) ((c def c (c (? . 0) q drracket:init:original-error-display-handler)) q (68979 . 5)) ((c def c (c (? . 0) q drracket:language:object/c)) q (31324 . 2)) ((c meth c (c (? . 15) q after-set-next-settings)) q (15173 . 4)) ((c def c (c (? . 0) q drscheme:unit:teachpack-callbacks-add)) q (91509 . 3)) ((c meth c (c (? . 6) q get-enabled)) q (5970 . 2)) ((c meth c (c (? . 1) q reorder-tabs)) q (12716 . 3)) ((c def c (c (? . 0) q drscheme:rep:get-error-delta)) q (90192 . 2)) ((c meth c (c (? . 8) q front-end/interaction)) q (27979 . 7)) ((c def c (c (? . 0) q drracket:debug:make-debug-compile-handler)) q (45375 . 4)) ((c meth c (c (? . 15) q set-needs-execution-message)) q (15671 . 4)) ((c def c (c (? . 0) q drscheme:debug:hide-backtrace-window)) q (71718 . 2)) ((c def c (c (? . 0) q drracket:language:text/pos?)) c (? . 16)) ((c def c (c (? . 0) q drracket:language:struct:text/pos)) q (38702 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:get-tab)) q (77762 . 3)) ((c meth c (c (? . 3) q get-language-numbers)) q (23402 . 3)) ((c def c (c (? . 0) q drscheme:language:text/pos-start)) q (85786 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings-printing-style)) c (? . 11)) ((c meth c (c (? . 2) q on-execute)) q (51494 . 3)) ((c meth c (c (? . 8) q front-end/finished-complete-program)) q (27852 . 4)) ((c constructor c (? . 19)) q (7277 . 3)) ((c def c (c (? . 0) q drscheme:get/extend:get-definitions-canvas)) q (79943 . 3)) ((c meth c (c (? . 26) q set-message)) q (55920 . 6)) ((c def c (c (? . 0) q drracket:debug:profile-definitions-text-mixin)) q (43271 . 4)) ((c def c (c (? . 0) q drracket:debug:test-coverage-on-style-name)) q (45792 . 2)) ((c def c (c (? . 0) q drscheme:frame:basics<%>)) q (70813 . 2)) ((c meth c (c (? . 17) q get-directory)) q (54095 . 2)) ((c def c (c (? . 0) q make-drracket:language-configuration:language-settings)) c (? . 10)) ((c meth c (c (? . 8) q create-executable)) q (26787 . 9)) ((c meth c (c (? . 3) q get-init-code)) q (23283 . 4)) ((c meth c (c (? . 5) q edit-menu:between-select-all-and-find)) q (8931 . 4)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-definitions-text-mixin)) q (69466 . 2)) ((c def c (c (? . 0) q drscheme:frame:basics-mixin)) q (70035 . 2)) ((c meth c (c (? . 4) q on-execute)) q (22232 . 3)) ((c def c (c (? . 0) q drscheme:modes:add-mode)) q (87241 . 8)) ((c def c (c (? . 0) q drracket:debug:small-planet-bitmap)) q (46184 . 2)) ((c def c (c (? . 0) q drscheme:debug:show-backtrace-window/edition-pairs/two)) q (73727 . 26)) ((c meth c (c (? . 5) q break-callback)) q (8536 . 2)) ((c meth c (c (? . 1) q get-tab-count)) q (11778 . 3)) ((c meth c (c (? . 7) q file-menu:new-callback)) q (56957 . 6)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-interactions-text-mixin)) q (69397 . 2)) ((c def c (c (? . 0) q drracket:module-language-tools:add-online-expansion-monitor)) q (66035 . 12)) ((c def c (c (? . 0) q drscheme:modes:mode-surrogate)) q (87697 . 3)) ((c meth c (c (? . 6) q on-close)) q (6325 . 2)) ((c def c (c (? . 0) q drscheme:tracing:tab-mixin)) q (70479 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:get-unit-frame)) q (77432 . 3)) ((c meth c (c (? . 21) q hide-profile-gui)) q (43002 . 3)) ((c meth c (c (? . 9) q add-show-menu-items)) q (58391 . 3)) ((c meth c (c (? . 4) q get-transformer-module)) q (21981 . 3)) ((c def c (c (? . 0) q drscheme:language:put-executable)) q (83731 . 8)) ((c meth c (c (? . 12) q get-reader)) q (19037 . 3)) ((c def c (c (? . 0) q drracket:rep:current-rep)) q (54926 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-annotations)) q (86857 . 3)) ((c meth c (c (? . 2) q highlight-errors/exn)) q (52407 . 3)) ((c def c (c (? . 0) q drracket:language:simple-module-based-language-convert-value)) q (37620 . 7)) ((c def c (c (? . 0) q drscheme:tracing:annotate)) q (92098 . 2)) ((c def c (? . 2)) q (50591 . 4)) ((c meth c (c (? . 5) q add-show-menu-items)) q (8420 . 4)) ((c def c (c (? . 0) q drscheme:modes:mode-name)) q (87626 . 2)) ((c meth c (c (? . 1) q prev-tab)) q (12515 . 2)) ((c meth c (c (? . 2) q get-user-custodian)) q (51733 . 3)) ((c def c (c (? . 0) q drscheme:module-language-tools:frame-mixin)) q (70627 . 2)) ((c meth c (c (? . 18) q front-end/interaction)) q (26153 . 3)) ((c meth c (c (? . 6) q get-defs)) q (5793 . 3)) ((c meth c (c (? . 5) q on-close)) q (10720 . 2)) ((c def c (c (? . 0) q drscheme:unit:add-search-help-desk-menu-item)) q (91149 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-module-based-language<%>)) q (70184 . 2)) ((c def c (c (? . 25) q syncheck-drracket-button)) q (0 . 7)) ((c def c (c (? . 0) q drscheme:eval:expand-program)) q (75498 . 12)) ((c meth c (c (? . 17) q get-breakables)) q (53978 . 4)) ((c def c (c (? . 0) q drscheme:debug:add-prefs-panel)) q (71777 . 2)) ((c def c (c (? . 0) q drracket:modes:mode-surrogate)) c (? . 14)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-tab-mixin)) q (69534 . 2)) ((c def c (c (? . 0) q drscheme:help-desk:help-desk)) q (80562 . 7)) ((c meth c (c (? . 1) q reopen-closed-tab)) q (12390 . 2)) ((c def c (c (? . 0) q drracket:eval:get-snip-classes)) q (59615 . 3)) ((c def c (c (? . 0) q drscheme:unit:frame<%>)) q (70889 . 2)) ((c meth c (c (? . 19) q clear-annotations)) q (7359 . 2)) ((c meth c (c (? . 6) q disable-evaluation)) q (5548 . 2)) ((c def c (c (? . 0) q drscheme:rep:text<%>)) q (69961 . 2)) ((c def c (c (? . 0) q drracket:get/extend:extend-interactions-text)) q (3292 . 9)) ((c def c (c (? . 0) q drscheme:unit:get-definitions-text%)) q (69768 . 2)) ((c def c (c (? . 0) q drracket:tracing:tab-mixin)) q (68562 . 4)) ((c meth c (c (? . 5) q get-button-panel)) q (9820 . 3)) ((c def c (c (? . 0) q drscheme:unit:teachpack-callbacks-remove)) q (91633 . 3)) ((c def c (c (? . 0) q drracket:get/extend:get-definitions-canvas)) q (4447 . 3)) ((c meth c (c (? . 6) q add-bkg-running-color)) q (6667 . 7)) ((c def c (c (? . 0) q drracket:debug:show-backtrace-window)) q (50036 . 11)) ((c def c (c (? . 0) q drracket:unit:teachpack-callbacks-remove)) c (? . 20)) ((c def c (c (? . 0) q drscheme:language:simple-module-based-language%)) q (70250 . 2)) ((c meth c (c (? . 8) q get-style-delta)) q (29236 . 7)) ((c def c (c (? . 0) q drracket:help-desk:help-desk)) q (58841 . 8)) ((c def c (c (? . 0) q drracket:language:get-capability-contract)) q (31915 . 3)) ((c def c (c (? . 29) q htdp-save-file-prefix)) q (351 . 2)) ((c sig-val c (c (? . 0) q drracket:tool-exports^ phase2)) q (588 . 2)) ((c meth c (c (? . 15) q get-next-settings)) q (15487 . 3)) ((c def c (c (? . 0) q drracket:language-configuration:get-settings-preferences-symbol)) q (40690 . 3)) ((c meth c (c (? . 8) q get-language-numbers)) q (28464 . 3)) ((c meth c (c (? . 8) q front-end/complete-program)) q (27523 . 7)) ((c def c (c (? . 0) q drscheme:debug:show-backtrace-window)) q (74982 . 8)) ((c def c (c (? . 0) q drscheme:module-language:module-language-put-file-mixin)) q (89903 . 3)) ((c meth c (c (? . 3) q default-settings)) q (23066 . 3)) ((c def c (c (? . 0) q drracket:get/extend:extend-interactions-canvas)) q (4557 . 9)) ((c meth c (c (? . 5) q update-save-message)) q (11008 . 3)) ((c def c (c (? . 0) q drracket:unit:add-to-program-editor-mixin)) q (16940 . 3)) ((c meth c (c (? . 2) q after-many-evals)) q (51432 . 2)) ((c def c (c (? . 0) q drracket:language-configuration:language-dialog)) q (41284 . 9)) ((c def c (c (? . 0) q drscheme:language-configuration:language-settings-language)) q (81381 . 3)) ((c meth c (c (? . 2) q kill-evaluation)) q (52748 . 2)) ((c def c (c (? . 0) q drracket:debug:test-coverage-definitions-text-mixin)) q (43456 . 5)) ((c meth c (c (? . 8) q metadata->settings)) q (29924 . 4)) ((c def c (c (? . 0) q drscheme:rep:current-value-port)) q (90422 . 2)) ((c def c (? . 21)) q (42740 . 4)) ((c def c (c (? . 0) q drracket:get/extend:get-definitions-text)) q (2767 . 10)) ((c def c (? . 4)) q (21169 . 5)) ((c meth c (c (? . 6) q reset-offer-kill)) q (6381 . 2)) ((c def c (c (? . 0) q drracket:language:simple-settings)) c (? . 11)) ((c def c (c (? . 0) q drracket:language-configuration:get-languages)) q (40055 . 3)) ((c meth c (c (? . 5) q get-editor%)) q (10338 . 2)) ((c meth c (c (? . 17) q disable-evaluation)) q (53725 . 2)) ((c def c (c (? . 0) q drracket:language:create-module-based-distribution)) q (35220 . 17)) ((c def c (c (? . 0) q drscheme:rep:current-rep)) q (90333 . 3)) ((c def c (c (? . 0) q drscheme:language:make-simple-settings)) q (87010 . 2)) ((c def c (? . 8)) q (26483 . 2)) ((c def c (c (? . 0) q struct:drracket:unit:teachpack-callbacks)) c (? . 20)) ((c def c (c (? . 0) q make-drracket:language:simple-settings)) c (? . 11)) ((c def c (c (? . 0) q drscheme:module-language-tools:add-opt-out-toolbar-button)) q (88277 . 8)) ((c meth c (c (? . 7) q get-additional-important-urls)) q (57542 . 3)) ((c meth c (c (? . 7) q help-menu:about-string)) q (57872 . 3)) ((c meth c (c (? . 4) q use-mred-launcher)) q (22711 . 3)) ((c meth c (c (? . 8) q get-language-position)) q (28573 . 3)) ((c meth c (c (? . 1) q close-ith-tab)) q (12911 . 3)) ((c def c (c (? . 0) q drscheme:language-configuration:fill-language-dialog)) q (82151 . 11)) ((c def c (c (? . 0) q drracket:module-language-tools:add-online-expansion-handler)) q (65511 . 11)) ((c def c (c (? . 0) q drracket:unit:get-definitions-text%)) q (16618 . 5)) ((c def c (c (? . 0) q drracket:get/extend:get-tab)) q (1659 . 3)) ((c def c (c (? . 0) q drracket:debug:test-coverage-off-style-name)) q (45853 . 2)) ((c def c (c (? . 0) q drscheme:modes:get-modes)) q (88205 . 2)) ((c def c (c (? . 0) q drracket:unit:teachpack-callbacks?)) c (? . 20)) ((c def c (c (? . 0) q drracket:unit:make-teachpack-callbacks)) q (18305 . 2)) ((c def c (c (? . 0) q drracket:modes:add-mode)) q (62884 . 13)) ((c def c (c (? . 0) q drscheme:module-language-tools:definitions-text<%>)) q (71055 . 2)) ((c def c (c (? . 0) q drracket:get/extend:extend-definitions-text)) q (1747 . 16)) ((c def c (c (? . 0) q drracket:debug:open-and-highlight-in-file)) q (46248 . 11)) ((c def c (c (? . 0) q drscheme:language-configuration:language-settings-settings)) q (81586 . 3)) ((c def c (c (? . 0) q drscheme:language:text/pos?)) q (85631 . 2)) ((c meth c (c (? . 4) q render-value/format)) q (22456 . 3)) ((c def c (c (? . 0) q drscheme:unit:teachpack-callbacks?)) q (91314 . 2)) ((c meth c (c (? . 6) q get-directory)) q (5889 . 3)) ((c def c (c (? . 0) q drracket:module-language-tools:done?)) q (66875 . 3)) ((c meth c (c (? . 2) q run-in-evaluation-thread)) q (53085 . 3)) ((c def c (c (? . 0) q drracket:unit:definitions-canvas%)) q (16535 . 3)) ((c def c (c (? . 0) q drscheme:module-language:add-module-language)) q (89838 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:extend-tab)) q (77520 . 6)) ((c meth c (c (? . 1) q create-new-tab)) q (12326 . 2)) ((c def c (c (? . 0) q drscheme:language:add-snip-value)) q (83226 . 6)) ((c meth c (c (? . 2) q get-user-thread)) q (52089 . 3)) ((c meth c (c (? . 13) q move-to-new-language)) q (67286 . 3)) ((c def c (c (? . 0) q drscheme:get/extend:allow-re-extension!)) q (80500 . 2)) ((c def c (c (? . 0) q drscheme:eval:traverse-program/multiple)) q (75935 . 12)) ((c def c (c (? . 0) q drscheme:module-language-tools:start?)) q (89489 . 2)) ((c def c (c (? . 0) q drscheme:language-configuration:struct:language-settings)) q (81720 . 3)) ((c def c (c (? . 0) q drscheme:modes:mode?)) q (87573 . 2)) ((c def c (c (? . 0) q drscheme:language:create-module-based-launcher)) q (84960 . 5)) ((c def c (c (? . 0) q drracket:frame:mixin)) q (56133 . 6)) ((c def c (c (? . 0) q drscheme:module-language-tools:register-online-expansion-pref)) q (89559 . 3)) ((c def c (c (? . 0) q drscheme:language:make-setup-printing-parameters)) q (85480 . 3)) ((c def c (c (? . 0) q drscheme:debug:make-debug-error-display-handler)) q (71562 . 4)) ((c meth c (c (? . 3) q on-execute)) q (24210 . 7)) ((c meth c (c (? . 5) q change-to-file)) q (8600 . 3)) ((c meth c (c (? . 6) q set-breakables)) q (6445 . 5)) ((c def c (c (? . 0) q drracket:get/extend:get-unit-frame)) q (1108 . 3)) ((c def c (c (? . 0) q drracket:rep:current-language-settings)) q (55273 . 6)) ((c def c (c (? . 0) q drracket:help-desk:goto-plt-license)) q (59236 . 2)) ((c def c (c (? . 0) q drscheme:eval:expand-program/multiple)) q (76419 . 13)) ((c meth c (c (? . 18) q on-execute)) q (26392 . 3)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-frame-mixin)) q (69589 . 2)) ((c def c (c (? . 0) q drscheme:modes:mode-repl-submit)) q (87812 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-module-based-language->module-based-language-mixin)) q (70314 . 3)) ((c meth c (c (? . 7) q help-menu:before-about)) q (57949 . 4)) ((c def c (c (? . 0) q drscheme:frame:mixin)) q (69998 . 2)) ((c def c (c (? . 0) q drscheme:language:module-based-language->language-mixin)) q (70407 . 2)) ((c def c (c (? . 0) q drscheme:unit:teachpack-callbacks-get-names)) q (91381 . 3)) ((c def c (c (? . 0) q drracket:language:add-snip-value)) q (32056 . 7)) ((c def c (c (? . 0) q drscheme:debug:profile-unit-frame-mixin)) q (69341 . 2)) ((c meth c (c (? . 1) q next-tab)) q (12457 . 2)) ((c meth c (c (? . 4) q config-panel)) q (21429 . 3)) ((c meth c (c (? . 3) q marshall-settings)) q (24083 . 4)) ((c def c (c (? . 0) q drracket:debug:test-coverage-tab-mixin)) q (43908 . 5)) ((c def c (c (? . 0) q drscheme:module-language-tools:frame<%>)) q (71176 . 2)) ((c def c (c (? . 0) q drscheme:language-configuration:get-settings-preferences-symbol)) q (81208 . 3)) ((c def c (c (? . 0) q drscheme:get/extend:extend-interactions-canvas)) q (80052 . 6)) ((c meth c (c (? . 22) q get-module)) q (20806 . 3)) ((c def c (? . 6)) q (5338 . 3)) ((c meth c (c (? . 5) q still-untouched?)) q (10835 . 2)) ((c def c (c (? . 0) q drscheme:debug:bug-info->ticket-url)) q (72340 . 4)) ((c meth c (c (? . 7) q file-menu:new-string)) q (57174 . 2)) ((c sig-val c (c (? . 0) q drracket:tool-exports^ phase1)) q (558 . 2)) ((c def c (c (? . 0) q drracket:language-configuration:language-settings)) c (? . 10)) ((c meth c (c (? . 2) q reset-console)) q (52958 . 2)) ((c def c (c (? . 0) q drracket:rep:current-value-port)) q (55016 . 2)) ((c meth c (c (? . 2) q on-close)) q (52811 . 2)) ((c meth c (c (? . 3) q get-reader)) q (23828 . 3)) ((c meth c (c (? . 27) q get-keymaps)) q (53510 . 3)) ((c def c (c (? . 0) q drscheme:language:struct:simple-settings)) q (87070 . 2)) ((c meth c (c (? . 5) q on-size)) q (10778 . 2)) ((c def c (c (? . 0) q drracket:debug:hide-backtrace-window)) q (45261 . 2)) ((c meth c (c (? . 15) q begin-metadata-changes)) q (15321 . 3)) ((c meth c (c (? . 2) q reset-highlighting)) q (53019 . 2)) ((c meth c (c (? . 22) q get-language-position)) q (20700 . 3)) ((c def c (c (? . 0) q drracket:language:put-executable)) q (32921 . 12)) ((c meth c (c (? . 3) q render-value/format)) q (24934 . 11)) ((c meth c (c (? . 23) q after-insert)) q (7760 . 6)) ((c def c (? . 9)) q (58240 . 5)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-off-style-name)) q (72211 . 2)) ((c def c (c (? . 0) q drscheme:rep:text%)) q (69926 . 2)) ((c meth c (c (? . 5) q get-break-button)) q (9740 . 3)) ((c def c (c (? . 0) q drscheme:rep:current-language-settings)) q (90570 . 3)) ((c meth c (c (? . 8) q get-one-line-summary)) q (29042 . 3)) ((c constructor c (? . 24)) q (8027 . 3)) ((c meth c (c (? . 6) q remove-bkg-running-color)) q (6965 . 3)) ((c meth c (c (? . 17) q set-breakables)) q (54312 . 5)) ((c def c (c (? . 0) q drscheme:language:struct:text/pos)) q (86049 . 2)) ((c def c (c (? . 0) q drscheme:language:get-capability-default)) q (82874 . 5)) ((c def c (c (? . 0) q drracket:language:extend-language-interface)) q (32381 . 7)) ((c def c (c (? . 0) q drracket:tracing:annotate)) q (68903 . 3)) ((c meth c (c (? . 5) q get-definitions/interactions-panel-parent)) q (10065 . 5)) ((c def c (c (? . 0) q drracket:tracing:frame-mixin)) q (68733 . 4)) ((c meth c (c (? . 15) q set-next-settings)) q (15785 . 7)) ((c def c (c (? . 0) q drscheme:debug:profile-tab-mixin)) q (69292 . 2)) ((c meth c (c (? . 3) q use-mred-launcher)) q (25597 . 3)) ((c meth c (c (? . 21) q show-profile-gui)) q (42921 . 3)) ((c meth c (c (? . 1) q ensure-rep-shown)) q (11463 . 3)) ((c def c (c (? . 0) q drracket:modes:mode?)) c (? . 14)) ((c def c (c (? . 0) q drscheme:language:module-based-language<%>)) q (70125 . 2)) ((c def c (c (? . 0) q drscheme:eval:get-snip-classes)) q (75417 . 3)) ((c def c (c (? . 0) q drracket:language:text/pos-end)) c (? . 16)) ((c def c (c (? . 0) q drscheme:init:original-error-display-handler)) q (92157 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-insert-newlines)) q (86745 . 3)) ((c def c (c (? . 0) q drscheme:language:create-module-based-stand-alone-executable)) q (84442 . 6)) ((c def c (c (? . 0) q drracket:get/extend:extend-unit-frame)) q (618 . 9)) ((c meth c (c (? . 2) q after-delete)) q (50837 . 2)) ((c def c (c (? . 0) q drscheme:module-language-tools:done)) q (89754 . 3)) ((c meth c (c (? . 6) q get-breakables)) q (5679 . 4)) ((c def c (c (? . 0) q drracket:module-language-tools:start?)) q (66643 . 3)) ((c meth c (c (? . 18) q front-end/complete-program)) q (26009 . 3)) ((c def c (c (? . 0) q drracket:eval:build-user-eventspace/custodian)) q (62259 . 11)) ((c meth c (c (? . 4) q get-init-code)) q (21825 . 4)) ((c def c (c (? . 0) q drscheme:module-language-tools:tab-mixin)) q (70686 . 2)) ((c def c (c (? . 0) q drscheme:language:text/pos-end)) q (85892 . 3)) ((c meth c (c (? . 6) q touched)) q (7060 . 2)) ((c def c (c (? . 0) q drscheme:module-language-tools:add-opt-in-toolbar-button)) q (88582 . 8)) ((c def c (c (? . 0) q drscheme:get/extend:extend-unit-frame)) q (77183 . 6)) ((c def c (c (? . 0) q drracket:language:text/pos-start)) c (? . 16)) ((c meth c (c (? . 15) q set-modified)) q (16426 . 4)) ((c def c (c (? . 0) q drscheme:module-language-tools:definitions-text-mixin)) q (70743 . 2)) ((c def c (c (? . 0) q drscheme:unit:find-symbol)) q (92001 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-fraction-style)) q (86449 . 3)) ((c def c (c (? . 0) q drracket:language:get-language-extensions)) q (32840 . 3)) ((c def c (c (? . 0) q drracket:language:text/pos-text)) c (? . 16)) ((c def c (c (? . 0) q drracket:language:create-executable-gui)) q (33425 . 14)) ((c meth c (c (? . 2) q get-user-namespace)) q (52000 . 3)) ((c meth c (c (? . 8) q get-language-name)) q (28387 . 3)) ((c def c (? . 5)) q (8156 . 5)) ((c def c (c (? . 0) q drracket:language-configuration:fill-language-dialog)) q (41872 . 15)) ((c def c (c (? . 0) q drscheme:language:setup-printing-parameters)) q (85340 . 3)) ((c def c (c (? . 0) q drscheme:language:get-default-mixin)) q (83545 . 3)) ((c def c (c (? . 0) q drracket:module-language-tools:add-opt-in-toolbar-button)) q (64943 . 11)) ((c def c (c (? . 0) q drracket:module-language-tools:add-opt-out-toolbar-button)) q (64371 . 11)) ((c meth c (c (? . 6) q break-callback)) q (5425 . 2)) ((c meth c (c (? . 1) q register-capability-menu-item)) q (13959 . 7)) ((c meth c (c (? . 8) q extra-repl-information)) q (29526 . 7)) ((c meth c (c (? . 1) q ensure-rep-hidden)) q (11396 . 2)) ((c def c (? . 18)) q (25789 . 5)) ((c meth c (c (? . 3) q get-one-line-summary)) q (23735 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings->vector)) q (39911 . 4)) ((c meth c (c (? . 2) q get-user-language-settings)) q (51913 . 3)) ((c meth c (c (? . 22) q get-reader)) q (21025 . 3)) ((c def c (c (? . 0) q drracket:language:setup-printing-parameters)) q (37938 . 7)) ((c meth c (c (? . 2) q initialize-console)) q (52621 . 2)) ((c def c (c (? . 0) q drscheme:language:make-text/pos)) q (85996 . 2)) ((c def c (c (? . 0) q drracket:unit:find-symbol)) q (18365 . 4)) ((c def c (c (? . 0) q drracket:eval:expand-program)) q (59697 . 18)) ((c meth c (c (? . 8) q get-comment-character)) q (28299 . 3)) ((c meth c (c (? . 17) q enable-evaluation)) q (53794 . 2)) ((c def c (c (? . 0) q drracket:language:text/pos)) c (? . 16)) ((c meth c (c (? . 15) q get-tab)) q (15578 . 3)) ((c def c (c (? . 0) q drscheme:language-configuration:make-language-settings)) q (81801 . 3)) ((c def c (c (? . 0) q drscheme:unit:teachpack-callbacks-remove-all)) q (91760 . 3)) ((c def c (c (? . 0) q drscheme:unit:open-drscheme-window)) q (90994 . 5)) ((c def c (c (? . 0) q drscheme:get/extend:extend-definitions-text)) q (77849 . 13)) ((c meth c (c (? . 22) q get-language-numbers)) q (20571 . 3)) ((c meth c (c (? . 5) q file-menu:print-string)) q (9523 . 2)) ((c def c (c (? . 0) q drracket:modes:mode-repl-submit)) c (? . 14)) ((c def c (c (? . 25) q syncheck-bitmap)) q (306 . 2)) ((c meth c (c (? . 15) q end-metadata-changes)) q (15405 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-case-sensitive)) q (86173 . 3)) ((c def c (c (? . 0) q drracket:module-language-tools:done)) q (66961 . 3)) ((c def c (c (? . 0) q drracket:module-language:add-module-language)) q (68329 . 2)) ((c def c (c (? . 0) q drscheme:language:create-distribution-for-executable)) q (84810 . 7)) ((c meth c (c (? . 3) q get-language-position)) q (23524 . 3)) ((c meth c (c (? . 2) q display-results)) q (50957 . 3)) ((c def c (c (? . 0) q drscheme:language-configuration:language-settings?)) q (81297 . 3)) ((c def c (c (? . 0) q drracket:unit:struct:teachpack-callbacks)) q (18241 . 2)) ((c def c (c (? . 0) q drscheme:rep:module-language-initial-run)) q (90686 . 3)) ((c def c (c (? . 0) q struct:drracket:modes:mode)) c (? . 14)) ((c meth c (c (? . 1) q unregister-toolbar-button)) q (14916 . 4)) ((c def c (c (? . 0) q drscheme:unit:interactions-canvas%)) q (69820 . 2)) ((c meth c (c (? . 4) q render-value)) q (22343 . 3)) ((c def c (c (? . 0) q drracket:rep:get-dark-green-delta)) q (54708 . 2)) ((c def c (c (? . 0) q drscheme:debug:profiling-enabled)) q (72273 . 2)) ((c def c (c (? . 0) q drscheme:language:get-capability-contract)) q (83087 . 4)) ((c def c (c (? . 0) q drracket:language:get-capability-default)) q (31737 . 4)) ((c def c (c (? . 0) q drscheme:get/extend:get-definitions-text)) q (78743 . 10)) ((c def c (c (? . 0) q drscheme:rep:get-dark-green-delta)) q (90118 . 2)) ((c def c (c (? . 0) q drscheme:unit:frame%)) q (69681 . 2)) ((c meth c (c (? . 2) q evaluate-from-port)) q (51060 . 9)) ((c meth c (c (? . 8) q on-execute)) q (30038 . 7)) ((c def c (c (? . 0) q drracket:debug:error-display-handler/stacktrace)) q (44344 . 14)) ((c meth c (c (? . 8) q get-metadata)) q (28771 . 6)) ((c meth c (c (? . 6) q get-frame)) q (6032 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings->vector)) q (87134 . 3)) ((c def c (c (? . 0) q drracket:language:create-module-based-stand-alone-executable)) q (34154 . 17)) ((c def c (c (? . 0) q drscheme:language:simple-module-based-language-convert-value)) q (85215 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-printing-style)) q (86284 . 3)) ((c meth c (c (? . 6) q get-last-touched)) q (7115 . 2)) ((c def c (c (? . 0) q drscheme:tool-exports^)) q (69191 . 2)) ((c def c (c (? . 0) q drracket:unit:teachpack-callbacks-remove-all)) c (? . 20)) ((c meth c (c (? . 8) q get-language-url)) q (28683 . 3)) ((c def c (c (? . 0) q drracket:language-configuration:struct:language-settings)) q (41126 . 3)) ((c def c (c (? . 0) q drscheme:unit:tab<%>)) q (70978 . 2)) ((c meth c (c (? . 5) q file-menu:save-as-string)) q (9595 . 2)) ((c def c (? . 1)) q (11166 . 3)) ((c constructor c (? . 26)) q (55766 . 4)) ((c def c (c (? . 0) q drracket:modes:struct:mode)) q (64248 . 2)) ((c meth c (c (? . 22) q get-one-line-summary)) q (20925 . 3)) ((c def c (c (? . 0) q drscheme:debug:make-debug-compile-handler)) q (71830 . 4)) ((c meth c (c (? . 5) q get-execute-button)) q (10414 . 3)) ((c meth c (c (? . 1) q get-interactions-text)) q (13538 . 3)) ((c def c (c (? . 0) q drscheme:tracing:frame-mixin)) q (70522 . 2)) ((c def c (c (? . 0) q drracket:debug:profiling-enabled)) q (45915 . 4)) ((c meth c (c (? . 7) q file-menu:between-open-and-revert)) q (56693 . 4)) ((c def c (c (? . 0) q drracket:debug:profile-tab-mixin)) q (43083 . 4)) ((c def c (c (? . 0) q drscheme:modes:struct:mode)) q (88155 . 2)) ((c def c (c (? . 0) q drscheme:language:simple-settings-show-sharing)) q (86636 . 3)) ((c meth c (c (? . 8) q default-settings)) q (27226 . 3)) ((c def c (? . 19)) q (7181 . 4)) ((c def c (c (? . 0) q drracket:modes:mode-intended-to-edit-programs?)) c (? . 14)) ((c meth c (c (? . 5) q find-matching-tab)) q (8691 . 4)) ((c meth c (c (? . 5) q get-canvas)) q (9910 . 3)) ((c meth c (c (? . 7) q file-menu:open-string)) q (57467 . 2)) ((c def c (c (? . 0) q drracket:module-language-tools:frame-mixin)) q (67941 . 4)) ((c meth c (c (? . 17) q ensure-rep-shown)) q (53862 . 3)) ((c def c (c (? . 0) q drscheme:debug:get-error-color)) q (74827 . 2)) ((c meth c (c (? . 17) q needs-execution)) q (54159 . 3)) ((c def c (c (? . 0) q drscheme:eval:build-user-eventspace/custodian)) q (76925 . 7)) ((c meth c (c (? . 1) q move-current-tab-right)) q (12573 . 2)) ((c meth c (c (? . 8) q render-value/format)) q (30739 . 11)) ((c meth c (c (? . 7) q help-menu:about-callback)) q (57651 . 6)) ((c def c (c (? . 0) q drscheme:debug:profile-definitions-text-mixin)) q (69230 . 2)) ((c def c (c (? . 0) q drracket:debug:test-coverage-interactions-text-mixin)) q (43647 . 6)) ((c meth c (c (? . 15) q set-filename)) q (16123 . 7)) ((c def c (c (? . 0) q drscheme:rep:after-expression)) q (90493 . 2)) ((c meth c (c (? . 5) q file-menu:save-string)) q (9669 . 2)) ((c meth c (c (? . 7) q file-menu:between-print-and-close)) q (56825 . 4)) ((c meth c (c (? . 12) q get-language-position)) q (18700 . 3)) ((c meth c (c (? . 17) q clear-annotations)) q (53657 . 2)) ((c def c (c (? . 0) q drracket:language:create-distribution-for-executable)) q (36208 . 9)) ((c meth c (c (? . 8) q capability-value)) q (26538 . 3)) ((c def c (? . 27)) q (53387 . 3)) ((c meth c (c (? . 1) q move-current-tab-left)) q (12645 . 2)) ((c def c (c (? . 0) q drracket:get/extend:extend-tab)) q (1197 . 9)) ((c meth c (c (? . 12) q get-language-numbers)) q (18571 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings?)) q (86106 . 2)) ((c def c (c (? . 0) q drscheme:module-language-tools:tab<%>)) q (71122 . 2)) ((c def c (c (? . 0) q drscheme:unit:struct:teachpack-callbacks)) q (91877 . 2)) ((c def c (c (? . 0) q drracket:module-language-tools:tab<%>)) q (67490 . 2)) ((c meth c (c (? . 2) q get-user-eventspace)) q (51822 . 3)) ((c meth c (c (? . 8) q unmarshall-settings)) q (31202 . 4)) ((c def c (c (? . 0) q drracket:language:simple-settings-case-sensitive)) c (? . 11)) ((c form c (c (? . 25) q syncheck:button-callback)) q (274 . 2)) ((c def c (c (? . 0) q drracket:debug:add-prefs-panel)) q (45321 . 2)) ((c def c (c (? . 0) q drracket:language:make-simple-settings)) q (39787 . 2)) ((c def c (c (? . 0) q drscheme:language:text/pos-text)) q (85691 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings-show-sharing)) c (? . 11)) ((c def c (? . 28)) q (67045 . 2)) ((c def c (c (? . 0) q drscheme:rep:context<%>)) q (71015 . 2)) ((c meth c (c (? . 17) q reset-offer-kill)) q (54245 . 2)) ((c meth c (c (? . 1) q on-tab-change)) q (13729 . 5)) ((c meth c (c (? . 1) q ensure-defs-shown)) q (11329 . 2)) ((c def c (c (? . 0) q drracket:module-language-tools:frame<%>)) q (67553 . 2)) ((c meth c (c (? . 6) q is-current-tab?)) q (6197 . 2)) ((c def c (c (? . 0) q drracket:rep:module-language-initial-run)) q (55530 . 4)) ((c def c (c (? . 0) q drracket:unit:get-program-editor-mixin)) q (16830 . 3)) ((c def c (c (? . 0) q drscheme:modes:mode-intended-to-edit-programs?)) q (88060 . 3)) ((c def c (? . 26)) q (55695 . 3)) ((c meth c (c (? . 5) q get-canvas%)) q (9991 . 2)) ((c def c (c (? . 0) q drracket:rep:get-welcome-delta)) q (54636 . 2)) ((c def c (c (? . 0) q drracket:eval:set-basic-parameters)) q (59295 . 7)) ((c def c (c (? . 0) q drscheme:module-language:module-language<%>)) q (70567 . 2)) ((c meth c (c (? . 8) q config-panel)) q (26634 . 4)) ((c meth c (c (? . 1) q get-tab-filename)) q (11670 . 3)) ((c meth c (c (? . 2) q highlight-errors)) q (52172 . 6)) ((c meth c (c (? . 5) q file-menu:between-save-as-and-print)) q (9391 . 4)) ((c def c (c (? . 0) q drracket:unit:teachpack-callbacks-add)) c (? . 20)) ((c meth c (c (? . 8) q default-settings?)) q (27303 . 4)) ((c def c (? . 23)) q (7424 . 4)) ((c def c (c (? . 0) q drscheme:module-language-tools:add-online-expansion-monitor)) q (89186 . 8)) ((c def c (c (? . 0) q drscheme:language:create-module-based-distribution)) q (84631 . 6)) ((c def c (c (? . 0) q drracket:modes:mode-name)) c (? . 14)) ((c def c (c (? . 29) q htdp-file-prefix?)) q (401 . 3)) ((c meth c (c (? . 8) q first-opened)) q (27417 . 4)) ((c def c (c (? . 0) q drracket:debug:make-debug-eval-handler)) q (45538 . 3)) ((c def c (c (? . 0) q drracket:get/extend:get-interactions-text)) q (3810 . 3)) ((c def c (c (? . 0) q drscheme:language-configuration:add-language)) q (80964 . 6)) ((c meth c (c (? . 8) q render-value)) q (30473 . 8)) ((c def c (c (? . 0) q drscheme:help-desk:goto-plt-license)) q (80792 . 2)) ((c meth c (c (? . 9) q get-show-menu)) q (58713 . 2)) ((c def c (c (? . 0) q drracket:module-language-tools:register-online-expansion-pref)) q (66730 . 4)) ((c def c (? . 22)) q (19181 . 4)) ((c meth c (c (? . 17) q update-running)) q (54538 . 3)) ((c def c (c (? . 0) q make-drracket:language:text/pos)) c (? . 16)) ((c def c (c (? . 0) q drracket:frame:basics<%>)) q (58149 . 3)) ((c meth c (c (? . 1) q get-language-menu)) q (11250 . 3)) ((c def c (c (? . 0) q drracket:language:capability-registered?)) q (31649 . 3)) ((c def c (c (? . 0) q drracket:rep:text<%>)) q (50545 . 2)) ((c meth c (c (? . 1) q get-tabs)) q (13634 . 3)) ((c constructor c (? . 2)) q (50692 . 4)) ((c def c (c (? . 0) q drscheme:debug:make-debug-eval-handler)) q (71988 . 3)) ((c def c (c (? . 0) q drracket:unit:teachpack-callbacks-get-names)) c (? . 20)) ((c meth c (c (? . 8) q get-metadata-lines)) q (28964 . 3)) ((c def c (c (? . 0) q drscheme:get/extend:extend-definitions-canvas)) q (79673 . 6)) ((c def c (c (? . 0) q drracket:unit:teachpack-callbacks)) c (? . 20)) ((c meth c (c (? . 7) q edit-menu:between-find-and-preferences)) q (56556 . 4)) ((c def c (c (? . 0) q drracket:unit:open-drscheme-window)) q (17079 . 6)) ((c meth c (c (? . 5) q get-text-to-search)) q (10496 . 3)) ((c def c (c (? . 0) q drscheme:unit:tab%)) q (69646 . 2)) ((c def c (c (? . 0) q drscheme:debug:open-and-highlight-in-file)) q (72522 . 9)) ((c def c (c (? . 0) q drracket:debug:show-backtrace-window/edition-pairs/two)) q (48040 . 33)) ((c def c (c (? . 0) q drscheme:tool^)) q (69160 . 2)) ((c def c (c (? . 0) q drscheme:language-configuration:get-languages)) q (80850 . 3)) ((c def c (c (? . 0) q drracket:language:create-module-based-launcher)) q (36666 . 17)) ((c meth c (c (? . 5) q execute-callback)) q (9065 . 2))))
value
...
 -> (->* () (any/c input-port?) (or/c syntax? eof-object?))
mixin
drracket:language:simple-module-based-language->module-based-language-mixin : (class?
. -> . class?)
...
  id : symbol?
  local-handler : (-> (is-a?/c drracket:unit:definitions-text<%>)
                      any/c
                      any)
procedure
...
  stx : syntax?
procedure
(drracket:init:original-error-display-handler message     
                                              exn)    -> any
  message : string?
  exn : any/c
value

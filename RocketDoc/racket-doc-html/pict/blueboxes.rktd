13007
((3) 0 () 24 ((q lib "pict/main.rkt") (q lib "pict/color.rkt") (q lib "pict/code.rkt") (q 22937 . 46) (q 15468 . 31) (q 0 . 18) (q lib "pict/tree-layout.rkt") (q 14704 . 25) (q 455 . 10) (q lib "pict/balloon.rkt") (q 5025 . 21) (q 3274 . 37) (q lib "pict/conditional.rkt") (q lib "pict/face.rkt") (q 7782 . 13) (q 31773 . 13) (q lib "pict/convert.rkt") (q 5999 . 29) (q lib "pict/shadow.rkt") (q 8072 . 124) (q 2664 . 9) (q lib "pict/flash.rkt") (q 7618 . 7) (q 18301 . 5)) () (h ! (equal) ((c def c (c (? . 0) q unsafe-dc)) q (2003 . 7)) ((c def c (c (? . 0) q lift-bottom-relative-to-baseline)) q (21711 . 7)) ((c def c (c (? . 0) q color-series)) q (46456 . 17)) ((c def c (c (? . 0) q scale-color)) q (46325 . 4)) ((c def c (c (? . 1) q brown)) q (40555 . 3)) ((c def c (c (? . 0) q current-expected-text-scale)) q (49186 . 4)) ((c def c (c (? . 0) q filled-rounded-rectangle)) c (? . 17)) ((c def c (c (? . 6) q binary-tree-layout?)) q (44766 . 3)) ((c def c (c (? . 1) q green)) q (40339 . 3)) ((c def c (c (? . 0) q scale)) q (18084 . 8)) ((c def c (c (? . 0) q cb-superimpose)) c (? . 4)) ((c def c (c (? . 2) q current-literal-color)) q (35853 . 4)) ((c def c (c (? . 2) q mzscheme-const-list)) q (36958 . 2)) ((c def c (c (? . 0) q lc-find)) c (? . 3)) ((c def c (c (? . 0) q fast-end)) q (39832 . 3)) ((c def c (c (? . 0) q rectangle)) c (? . 10)) ((c def c (c (? . 1) q gray)) q (40609 . 3)) ((c def c (c (? . 0) q explain)) q (674 . 13)) ((c form c (c (? . 0) q scale/improve-new-text)) q (20552 . 3)) ((c def c (c (? . 0) q lbl-find)) c (? . 3)) ((c def c (c (? . 0) q translate)) q (19198 . 6)) ((c def c (c (? . 0) q pict-height)) c (? . 5)) ((c def c (c (? . 9) q balloon-enable-3d)) q (32329 . 4)) ((c def c (c (? . 0) q lt-superimpose)) c (? . 4)) ((c def c (c (? . 0) q fade-around-pict)) q (39023 . 5)) ((c def c (c (? . 0) q drop-below-ascent)) q (22363 . 4)) ((c def c (c (? . 0) q rbl-superimpose)) c (? . 4)) ((c def c (c (? . 0) q ht-append)) c (? . 7)) ((c def c (c (? . 0) q ghost)) q (19356 . 3)) ((c form c (c (? . 2) q define-code)) q (37458 . 3)) ((c def c (c (? . 2) q current-code-font)) q (34852 . 4)) ((c def c (c (? . 0) q flip-x)) c (? . 23)) ((c def c (c (? . 0) q inset)) q (21203 . 14)) ((c def c (c (? . 0) q child-syx)) c (? . 8)) ((c def c (c (? . 0) q blank)) q (2187 . 15)) ((c def c (c (? . 2) q pict->code-pict)) q (38334 . 4)) ((c def c (c (? . 0) q make-pict)) c (? . 5)) ((c def c (c (? . 0) q refocus)) q (22533 . 4)) ((c def c (c (? . 1) q black)) q (40501 . 3)) ((c def c (c (? . 0) q lb-superimpose)) c (? . 4)) ((c def c (c (? . 6) q hv-alternating)) q (45792 . 9)) ((c def c (c (? . 0) q hc-append)) c (? . 7)) ((c def c (c (? . 2) q code-colorize-quote-enabled)) q (37112 . 4)) ((c def c (c (? . 0) q slide-pict/center)) q (39330 . 7)) ((c def c (c (? . 0) q pict->argb-pixels)) q (47995 . 4)) ((c def c (c (? . 0) q struct:child)) c (? . 8)) ((c def c (c (? . 0) q text)) q (2477 . 6)) ((c def c (c (? . 9) q balloon-point-x)) c (? . 15)) ((c def c (c (? . 0) q lift-above-baseline)) q (22260 . 4)) ((c def c (c (? . 0) q filled-rectangle)) c (? . 10)) ((c def c (c (? . 0) q pict-draw)) c (? . 5)) ((c def c (c (? . 1) q cyan)) q (40716 . 3)) ((c def c (c (? . 9) q current-balloon-color)) q (32164 . 4)) ((c def c (c (? . 2) q current-keyword-list)) q (36524 . 4)) ((c def c (c (? . 0) q htl-append)) c (? . 7)) ((c def c (c (? . 0) q frame)) q (2926 . 9)) ((c def c (c (? . 0) q use-last)) q (22715 . 4)) ((c def c (c (? . 0) q file-icon)) q (24814 . 6)) ((c form c (c (? . 12) q pict-if)) q (43179 . 5)) ((c def c (c (? . 6) q naive-layered)) q (44887 . 9)) ((c def c (c (? . 0) q rb-superimpose)) c (? . 4)) ((c def c (c (? . 0) q ctl-superimpose)) c (? . 4)) ((c def c (c (? . 0) q ct-superimpose)) c (? . 4)) ((c def c (c (? . 0) q lt-find)) c (? . 3)) ((c def c (c (? . 0) q clip)) q (20110 . 3)) ((c def c (c (? . 0) q thermometer)) q (26197 . 20)) ((c def c (c (? . 0) q drop-top-relative-to-ascent)) q (21994 . 7)) ((c def c (c (? . 0) q draw-pict)) q (47405 . 6)) ((c def c (c (? . 0) q ltl-superimpose)) c (? . 4)) ((c def c (c (? . 2) q code-align)) q (36465 . 3)) ((c def c (c (? . 2) q code-pict-bottom-line-pict)) q (38247 . 3)) ((c def c (c (? . 13) q face*)) q (32625 . 30)) ((c def c (c (? . 2) q current-comment-color)) q (35368 . 4)) ((c def c (c (? . 1) q yellow)) q (40284 . 3)) ((c def c (c (? . 9) q wrap-balloon)) q (30029 . 14)) ((c def c (c (? . 1) q dark)) q (40885 . 3)) ((c def c (c (? . 1) q color/c)) q (40944 . 2)) ((c def c (c (? . 2) q current-literal-list)) q (36778 . 4)) ((c def c (c (? . 0) q rc-find)) c (? . 3)) ((c def c (c (? . 0) q pip-arrows-line)) c (? . 14)) ((c def c (c (? . 0) q bitmap)) q (7441 . 6)) ((c def c (c (? . 0) q make-pict-drawer)) q (48276 . 4)) ((c def c (c (? . 0) q disk)) c (? . 11)) ((c def c (c (? . 0) q argb-pixels->pict)) q (48159 . 4)) ((c def c (c (? . 0) q table)) q (17277 . 15)) ((c def c (c (? . 0) q pict)) c (? . 5)) ((c def c (c (? . 0) q dc)) q (1826 . 7)) ((c def c (c (? . 0) q reverse-animations)) q (39627 . 3)) ((c def c (c (? . 2) q code-transformer?)) q (37783 . 3)) ((c def c (c (? . 2) q current-code-line-sep)) q (35265 . 4)) ((c def c (c (? . 0) q standard-fish)) q (24988 . 13)) ((c def c (c (? . 2) q literal-color)) q (38188 . 2)) ((c def c (c (? . 0) q struct:pict)) c (? . 5)) ((c def c (c (? . 6) q tree-layout)) q (43753 . 4)) ((c def c (c (? . 21) q filled-flash)) q (33996 . 11)) ((c def c (c (? . 0) q pin-arrow-line)) c (? . 19)) ((c def c (c (? . 2) q keyword-color)) q (38075 . 2)) ((c def c (c (? . 0) q lbl-superimpose)) c (? . 4)) ((c def c (c (? . 2) q current-keyword-color)) q (35533 . 4)) ((c def c (c (? . 0) q cloud)) q (24502 . 8)) ((c def c (c (? . 2) q current-base-color)) q (36179 . 4)) ((c def c (c (? . 0) q child-sxy)) c (? . 8)) ((c def c (c (? . 0) q rtl-superimpose)) c (? . 4)) ((c def c (c (? . 2) q current-reader-forms)) q (36338 . 4)) ((c def c (c (? . 0) q ellipse)) c (? . 11)) ((c def c (c (? . 0) q colorize)) q (19821 . 5)) ((c def c (c (? . 0) q child?)) c (? . 8)) ((c def c (c (? . 0) q convert-bounds-padding)) q (47197 . 5)) ((c form c (c (? . 2) q define-exec-code)) q (37846 . 3)) ((c def c (c (? . 0) q fast-edges)) q (39911 . 3)) ((c def c (c (? . 2) q code-colorize-enabled)) q (37006 . 4)) ((c def c (c (? . 0) q hline)) c (? . 20)) ((c form c (c (? . 12) q pict-cond)) q (43309 . 5)) ((c def c (c (? . 0) q circle)) c (? . 11)) ((c def c (c (? . 0) q vc-append)) c (? . 7)) ((c def c (c (? . 2) q current-token-class->color)) q (38616 . 5)) ((c def c (c (? . 2) q racket/base-const-list)) q (36907 . 2)) ((c def c (c (? . 0) q pict-descent)) c (? . 5)) ((c def c (c (? . 0) q pict-ascent)) c (? . 5)) ((c def c (c (? . 0) q clip-descent)) q (21566 . 3)) ((c def c (c (? . 0) q pin-under)) q (16901 . 11)) ((c def c (c (? . 1) q orange)) q (40229 . 3)) ((c def c (c (? . 2) q get-current-code-font-size)) q (35096 . 4)) ((c def c (c (? . 0) q angel-wing)) q (25982 . 5)) ((c def c (c (? . 0) q arrowhead)) c (? . 22)) ((c def c (c (? . 0) q child-sy)) c (? . 8)) ((c def c (c (? . 6) q tree-edge?)) q (44831 . 3)) ((c def c (c (? . 0) q cbl-find)) c (? . 3)) ((c def c (c (? . 1) q red)) q (40177 . 3)) ((c def c (c (? . 0) q explain-child)) q (1197 . 15)) ((c def c (c (? . 0) q linestyle)) q (19523 . 7)) ((c def c (c (? . 9) q pin-balloon)) q (31104 . 11)) ((c form c (c (? . 12) q pict-case)) q (43437 . 5)) ((c def c (c (? . 0) q linewidth)) q (19422 . 4)) ((c def c (c (? . 16) q prop:pict-convertible)) q (49341 . 2)) ((c def c (c (? . 0) q rt-superimpose)) c (? . 4)) ((c def c (c (? . 0) q dc-for-text-size)) q (47060 . 4)) ((c def c (c (? . 2) q make-code-transformer)) q (37556 . 4)) ((c def c (c (? . 2) q codeblock-pict)) q (38441 . 5)) ((c def c (c (? . 0) q ct-find)) c (? . 3)) ((c def c (c (? . 13) q face)) q (32490 . 4)) ((c def c (c (? . 0) q desktop-machine)) q (26081 . 4)) ((c def c (c (? . 0) q pict-panbox)) c (? . 5)) ((c def c (c (? . 12) q hide)) q (43664 . 4)) ((c def c (c (? . 0) q bitmap-draft-mode)) q (14606 . 4)) ((c def c (c (? . 0) q text-style/c)) q (14573 . 2)) ((c def c (c (? . 0) q inset/clip)) q (20174 . 14)) ((c def c (c (? . 0) q pip-line)) c (? . 14)) ((c def c (c (? . 0) q child-pict)) c (? . 8)) ((c form c (c (? . 2) q define-exec-code/scale)) q (37922 . 3)) ((c def c (c (? . 0) q pict->bitmap)) q (47545 . 9)) ((c def c (c (? . 6) q tree-layout?)) q (44708 . 3)) ((c def c (c (? . 2) q current-const-list)) q (36653 . 4)) ((c def c (c (? . 0) q hyperlinkize)) q (46252 . 3)) ((c def c (c (? . 1) q light)) q (40825 . 3)) ((c def c (c (? . 9) q balloon-pict)) c (? . 15)) ((c def c (c (? . 0) q pin-over)) q (16534 . 11)) ((c def c (c (? . 0) q vr-append)) c (? . 7)) ((c def c (c (? . 0) q shear)) q (19066 . 5)) ((c def c (c (? . 0) q rtl-find)) c (? . 3)) ((c def c (c (? . 0) q cc-superimpose)) c (? . 4)) ((c def c (c (? . 0) q slide-pict)) q (39165 . 7)) ((c def c (c (? . 0) q fade-pict)) q (38828 . 6)) ((c def c (c (? . 9) q balloon-color)) q (32105 . 2)) ((c def c (c (? . 0) q fast-middle)) q (39992 . 3)) ((c form c (c (? . 2) q code)) q (34826 . 2)) ((c def c (c (? . 13) q default-face-color)) q (32427 . 2)) ((c def c (c (? . 0) q ltl-find)) c (? . 3)) ((c def c (c (? . 0) q cbl-superimpose)) c (? . 4)) ((c def c (c (? . 0) q pict?)) c (? . 5)) ((c def c (c (? . 18) q blur)) q (40977 . 5)) ((c def c (c (? . 0) q child-sx)) c (? . 8)) ((c def c (c (? . 0) q rt-find)) c (? . 3)) ((c def c (c (? . 0) q sequence-animations)) q (39502 . 3)) ((c def c (c (? . 9) q balloon)) q (31427 . 10)) ((c def c (c (? . 2) q comment-color)) q (38016 . 2)) ((c def c (c (? . 16) q pict-convert)) q (49513 . 3)) ((c def c (c (? . 0) q rbl-find)) c (? . 3)) ((c def c (c (? . 2) q current-id-color)) q (35698 . 4)) ((c def c (c (? . 1) q blue)) q (40393 . 3)) ((c def c (c (? . 0) q child-dx)) c (? . 8)) ((c def c (c (? . 0) q pict-path?)) q (24378 . 3)) ((c def c (c (? . 12) q show)) q (43575 . 4)) ((c def c (c (? . 0) q baseless)) q (22464 . 3)) ((c def c (c (? . 0) q cellophane)) q (19998 . 4)) ((c def c (c (? . 0) q black-and-white)) q (20671 . 4)) ((c def c (c (? . 0) q rounded-rectangle)) c (? . 17)) ((c def c (c (? . 18) q shadow-frame)) q (41716 . 27)) ((c def c (c (? . 0) q rotate)) q (18972 . 4)) ((c def c (c (? . 6) q binary-tidier)) q (45336 . 9)) ((c def c (c (? . 0) q lb-find)) c (? . 3)) ((c def c (c (? . 0) q pin-arrows-line)) c (? . 19)) ((c def c (c (? . 0) q vline)) c (? . 20)) ((c def c (c (? . 21) q outline-flash)) q (34378 . 11)) ((c def c (c (? . 18) q shadow)) q (41163 . 13)) ((c def c (c (? . 2) q code-italic-underscore-enabled)) q (37230 . 4)) ((c def c (c (? . 16) q pict-convertible?)) q (49450 . 3)) ((c def c (c (? . 9) q balloon?)) c (? . 15)) ((c def c (c (? . 0) q arrow)) c (? . 22)) ((c def c (c (? . 1) q magenta)) q (40769 . 3)) ((c def c (c (? . 0) q fast-start)) q (39751 . 3)) ((c def c (c (? . 0) q panorama)) q (22646 . 3)) ((c def c (c (? . 2) q current-const-color)) q (36018 . 4)) ((c def c (c (? . 0) q scale-to-fit)) q (18425 . 14)) ((c def c (c (? . 0) q show-pict)) q (48396 . 15)) ((c def c (c (? . 0) q pict-width)) c (? . 5)) ((c def c (c (? . 0) q clip-ascent)) q (21639 . 3)) ((c def c (c (? . 0) q hb-append)) c (? . 7)) ((c def c (c (? . 0) q child)) c (? . 8)) ((c def c (c (? . 9) q make-balloon)) c (? . 15)) ((c def c (c (? . 2) q id-color)) q (38134 . 2)) ((c def c (c (? . 0) q flip-y)) c (? . 23)) ((c def c (c (? . 0) q rc-superimpose)) c (? . 4)) ((c def c (c (? . 0) q freeze)) q (20765 . 10)) ((c def c (c (? . 0) q standard-cat)) q (27262 . 53)) ((c def c (c (? . 0) q cb-find)) c (? . 3)) ((c def c (c (? . 0) q pin-line)) c (? . 19)) ((c def c (c (? . 0) q jack-o-lantern)) q (25582 . 9)) ((c def c (c (? . 0) q cc-find)) c (? . 3)) ((c def c (c (? . 9) q balloon-point-y)) c (? . 15)) ((c def c (c (? . 0) q ctl-find)) c (? . 3)) ((c def c (c (? . 0) q pict-children)) c (? . 5)) ((c def c (c (? . 1) q purple)) q (40446 . 3)) ((c def c (c (? . 9) q pip-wrap-balloon)) q (30556 . 14)) ((c def c (c (? . 0) q pict-last)) c (? . 5)) ((c def c (c (? . 1) q white)) q (40662 . 3)) ((c def c (c (? . 0) q lc-superimpose)) c (? . 4)) ((c def c (c (? . 0) q launder)) q (24434 . 3)) ((c def c (c (? . 6) q tree-edge)) q (43922 . 15)) ((c def c (c (? . 2) q current-code-tt)) q (34965 . 4)) ((c def c (c (? . 0) q pip-arrow-line)) c (? . 14)) ((c def c (c (? . 0) q use-last*)) q (22822 . 4)) ((c def c (c (? . 16) q prop:pict-convertible?)) q (49395 . 2)) ((c def c (c (? . 0) q rb-find)) c (? . 3)) ((c def c (c (? . 0) q split-phase)) q (40074 . 3)) ((c def c (c (? . 2) q prop:code-transformer)) q (37729 . 2)) ((c def c (c (? . 2) q typeset-code)) q (34765 . 3)) ((c def c (c (? . 0) q filled-ellipse)) c (? . 11)) ((c def c (c (? . 0) q child-dy)) c (? . 8)) ((c def c (c (? . 0) q vl-append)) c (? . 7)) ((c def c (c (? . 0) q hbl-append)) c (? . 7)) ((c def c (c (? . 0) q make-child)) c (? . 8)) ((c def c (c (? . 2) q code-scripts-enabled)) q (37354 . 4))))
struct
(struct pict (draw
              width
              height
...
  color : (or/c #f string? (is-a?/c color%)) = #f
  alpha : (real-in 0.0 1.0) = 1.0
  style : (or/c 'transparent 'solid 'xor 'hilite        = #f
...
              #:lip-border-width lip-border-width     
              #:eye-color eye-color                   
...
  height : positive?
  left-ear-extent : (>=/c 0)
  left-ear-arc : (real-in 0 (* 2 pi))
  left-ear-angle : (real-in 0 (* 2 pi))
  right-ear-extent : (>=/c 0)
  right-ear-arc : (real-in 0 (* 2 pi))
  right-ear-angle : (real-in 0 (* 2 pi))
  fur-color : (or/c #f string? (is-a?/c color%))
  fur-border-color : (or/c #f string? (is-a?/c color%))
  lip-color : (or/c #f string? (is-a?/c color%))
  lip-border-color : (or/c string? (is-a?/c color%))
  lip-border-width : (or/c #f (real-in 0 255))
  eye-color : (or/c #f string? (is-a?/c color%))
  nose-color : (or/c #f string? (is-a?/c color%))
  nose : pict?
  happy? : any/c
  eyes : (or/c #f pict?)
  left-eye : (if eyes (or/c #f pict?) pict?)
  right-eye : (if eyes (or/c #f pict?) pict?)
  whisker-length : positive?
  whisker-droop : real?
  whisker-width : (or/c #f (real-in 0 255))
  whisker-color : (or/c string? (is-a?/c color%))
  whisker-inset? : any/c
...
(current-balloon-color color) -> void?
  color : (or/c string? (is-a?/c color%))
parameter
...
  bl-pict : (or/c pict? #f)
procedure
(codeblock-pict  code-string                   
                [#:keep-lang-line? keep?]) -> pict?
  code-string : string?
  keep? : any/c = #t
parameter
(current-token-class->color)
 -> (-> symbol? (or/c string? (is-a?/c color%)))
(current-token-class->color to-color) -> void?
  to-color : (-> symbol? (or/c string? (is-a?/c color%)))
procedure
...
  edge-style : (or/c 'unspecified 'transparent 'solid 'xor 'hilite
                     'dot 'long-dash 'short-dash 'dot-dash
                     'xor-dot 'xor-long-dash 'xor-short-dash
                     'xor-dot-dash)
             = 'unspecified
...
  make-a-bitmap : (exact-positive-integer? exact-positive-integer?
                   . -> . (is-a?/c bitmap%))
                = make-bitmap
procedure

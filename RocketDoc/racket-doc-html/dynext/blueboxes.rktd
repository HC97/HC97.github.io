2512
((3) 0 () 3 ((q lib "dynext/file.rkt") (q lib "dynext/link.rkt") (q lib "dynext/compile.rkt")) () (h ! (equal) ((c def c (c (? . 2) q current-extension-compiler-flags)) q (488 . 7)) ((c def c (c (? . 0) q extract-base-filename/kp)) q (4705 . 4)) ((c def c (c (? . 1) q link-variant)) q (3552 . 4)) ((q def ((lib "dynext/compile-unit.rkt") dynext:compile@)) q (2182 . 2)) ((c def c (c (? . 0) q append-c-suffix)) q (4209 . 3)) ((c def c (c (? . 1) q use-standard-linker)) q (3709 . 3)) ((c def c (c (? . 0) q append-zo-suffix)) q (4063 . 3)) ((c def c (c (? . 1) q current-extension-linker-flags)) q (2603 . 5)) ((c def c (c (? . 2) q get-standard-compilers)) q (1967 . 2)) ((q form ((lib "dynext/file-sig.rkt") dynext:file^)) q (5098 . 2)) ((c def c (c (? . 1) q expand-for-link-variant)) q (3815 . 5)) ((c def c (c (? . 1) q current-use-mzdyn)) q (3437 . 4)) ((c def c (c (? . 0) q extract-base-filename/o)) q (4836 . 4)) ((q form ((lib "dynext/link-sig.rkt") dynext:link^)) q (3997 . 2)) ((q def ((lib "dynext/file-unit.rkt") dynext:file@)) q (5135 . 2)) ((c def c (c (? . 0) q extract-base-filename/c)) q (4575 . 4)) ((c def c (c (? . 1) q link-extension)) q (2214 . 7)) ((c def c (c (? . 2) q current-make-compile-include-strings)) q (816 . 5)) ((c def c (c (? . 0) q extract-base-filename/ext)) q (4966 . 4)) ((c def c (c (? . 2) q current-extension-preprocess-flags)) q (1450 . 5)) ((c def c (c (? . 0) q append-constant-pool-suffix)) q (4274 . 3)) ((c def c (c (? . 2) q compile-variant)) q (1698 . 4)) ((c def c (c (? . 0) q append-object-suffix)) q (4139 . 3)) ((q def ((lib "dynext/link-unit.rkt") dynext:link@)) q (4034 . 2)) ((q form ((lib "dynext/compile-sig.rkt") dynext:compile^)) q (2142 . 2)) ((c def c (c (? . 2) q current-make-compile-input-strings)) q (1016 . 5)) ((c def c (c (? . 1) q current-extension-linker)) q (2440 . 4)) ((c def c (c (? . 0) q append-extension-suffix)) q (4361 . 3)) ((c def c (c (? . 1) q current-make-link-input-strings)) q (2829 . 5)) ((c def c (c (? . 1) q current-standard-link-libraries)) q (3211 . 5)) ((c def c (c (? . 0) q extract-base-filename/ss)) q (4444 . 4)) ((c def c (c (? . 2) q expand-for-compile-variant)) q (2025 . 3)) ((c def c (c (? . 2) q compile-extension)) q (0 . 9)) ((c def c (c (? . 2) q current-make-compile-output-strings)) q (1232 . 5)) ((c def c (c (? . 2) q use-standard-compiler)) q (1861 . 3)) ((c def c (c (? . 2) q current-extension-compiler)) q (317 . 4)) ((c def c (c (? . 1) q current-make-link-output-strings)) q (3019 . 5))))
procedure

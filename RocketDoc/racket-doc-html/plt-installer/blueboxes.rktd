371
((3) 0 () 1 ((q lib "setup/plt-installer.rkt")) () (h ! (equal) ((c def c (c (? . 0) q on-installer-run)) q (77 . 4)) ((q form ((lib "setup/plt-installer-sig.rkt") setup:plt-installer^)) q (883 . 2)) ((c def c (c (? . 0) q run-installer)) q (0 . 3)) ((c def c (c (? . 0) q run-single-installer)) q (423 . 9)) ((c def c (c (? . 0) q with-installer-window)) q (182 . 6))))
procedure

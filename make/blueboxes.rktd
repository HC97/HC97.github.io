1070
((3) 0 () 2 ((q lib "make/main.rkt") (q 521 . 5)) () (h ! (equal) ((c def c (c (? . 0) q exn:fail:make)) c (? . 1)) ((q form ((lib "make/make-sig.rkt") make^)) q (1007 . 2)) ((q def ((lib "make/collection-unit.rkt") make:collection@)) q (2363 . 2)) ((c def c (c (? . 0) q exn:fail:make-orig-exn)) c (? . 1)) ((c def c (c (? . 0) q exn:fail:make-targets)) c (? . 1)) ((c def c (c (? . 0) q struct:exn:fail:make)) c (? . 1)) ((c def c (c (? . 0) q make-print-reasons)) q (907 . 4)) ((q def ((lib "make/setup-extension.rkt") pre-install)) q (1059 . 25)) ((q def ((lib "make/collection.rkt") make-collection)) q (2048 . 7)) ((q form ((lib "make/collection-sig.rkt") make:collection^)) q (2322 . 2)) ((c def c (c (? . 0) q make-exn:fail:make)) c (? . 1)) ((c def c (c (? . 0) q exn:fail:make?)) c (? . 1)) ((c def c (c (? . 0) q make-print-dep-no-line)) q (799 . 4)) ((c def c (c (? . 0) q make-print-checking)) q (697 . 4)) ((c form c (c (? . 0) q make)) q (0 . 5)) ((q def ((lib "make/make-unit.rkt") make@)) q (1037 . 2)) ((c def c (c (? . 0) q make/proc)) q (127 . 8))))
syntax
